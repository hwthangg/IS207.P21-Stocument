...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <div onclick="window.location.href='document.php'" class="menu-item" >
                <i class="fas fa-file-alt menu-item active"></i> Quản lý tài liệu
            </div>
    ...
    <div class="main-content">
        ...
        <div class="row">
            ...
            <h4 class="fw-bold">TÀI LIỆU</h4>
  
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                    
                        <div class="text-end mb-4">
                            <input type="text" oninput="search_document(this.value)" class="form-control w-25 ms-auto" id="search" placeholder="Tìm kiếm tài liệu hoặc mã môn">
                        </div>
                            ...
                            <table class="table table-hover border text-center" style="min-width: 1600px; width: auto;">
                                <thead>
                                    <tr class="bg-dark text-light">
                                        ...
                                        <th scope="col" width="20%">Mã môn</th>
                                        <th scope="col" class="text-nowrap">Họ và tên</th>
                                        <th scope="col" class="text-nowrap ">Tên người dùng</th>                                                                                           
                                        <th scope="col" class="text-nowrap">Số lượt download</th>
                                        <th scope="col" class="text-nowrap">Ngày đăng tải</th>                                 
                                        <th scope="col" class="text-nowrap">Xoá tài liệu</th>
                                    </tr>
                                </thead>   
